...
todos:
  ...
  - id: pa-deploy-test
    ...
    status: completed
  - id: stadium-assets
    content: 16 球场图（ArchDaily.cn 图源）+ 简报页 WC 2026 Logo
    status: completed
...
1. （可选）淘汰赛 fixtures sync（API 占位队名 TBD）

**已完成（2026-06-08）**：射手积分榜、WC Logo、PA git push、Windows 20:00 任务、`static/stadiums/` 16 球场图（ArchDaily.cn）。
